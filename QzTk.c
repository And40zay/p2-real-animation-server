...
int main(int argc, char** argv) {
    ...
    if (!s_cross) { fprintf(stderr, "ERROR: Failed to load crosshair.bmp (animate_create_sprite returned NULL)\n"); goto cleanup; }
    s_rick = animate_create_sprite("rick.bmp");
    if (!s_rick) { fprintf(stderr, "ERROR: Failed to load rick.bmp (animate_create_sprite returned NULL)\n"); goto cleanup; }
