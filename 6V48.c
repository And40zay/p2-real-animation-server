...
int main(int argc, char** argv) {
    struct canvas* canvas = animate_create_canvas(10, 10, animate_color_argb(0, 0, 0, 0));// animate_create_canvas(size_t height, size_t width, color_t background_color)
    //size_tsize_t
