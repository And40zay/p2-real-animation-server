 ...
 */
typedef void (*animate_fn)(void* priv, size_t* x, size_t* y, float t);
 ...
 */
struct sprite_placement* animate_p(size_t vx, size_t vy, size_t ax, size_t ay);

place_sprite(struct canvas* canvas,struct sprite* sprite, size_t x, size_t y);
