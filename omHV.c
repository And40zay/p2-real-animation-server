...
struct sprite_placement {
    ...
    size_t x;
    size_t y;
    size_t vx; // velocity in x direction
    size_t vy; // velocity in y direction
    size_t ax; // acceleration in x direction
    size_t ay; // acceleration in y direction
};
...
anistruct sprite* animate_create_rectangle(size_t width, size_t height, color_t c, bool filled)
{
    // TODO
...
void animate_set_animation_params(struct sprite_placement* sprite_placement,size_t vx, size_t vy,size_t ax, size_t ay)
{
    // TODO
...
{
    // TODO
    memset(buf, 0, animate_frame_size_bytes(canvas));
}

// Optional extension
void animate_set_animation_function(struct sprite_placement* sprite_placement,animate_fn, void* priv) 
{
